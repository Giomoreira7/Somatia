(function ($) {
  ...
  if ($("#traffic-chart").length) {
    ...
    var gradientStrokeViolet = graphGradient3.createLinearGradient(0, 0, 0, 300);
    gradientStrokeViolet.addColorStop(0, 'rgba(204, 128, 255, 1)');
    gradientStrokeViolet.addColorStop(1, 'rgba(92, 32, 100, 1)');
    var gradientStrokeViolet= 'rgba(204, 128, 255, 1)';
    ...
    new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ['Corretivo 30%', 'Rimel 30%', 'Base 40%'],
        datasets: [{
          data: [30, 30, 40],
          backgroundColor: [gradientStrokeBlue,  gradientStrokeRed, gradientStrokeViolet],
